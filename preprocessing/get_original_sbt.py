...
def SBT(ast):
    ...
    for w in ast:
        nast[w['id']] = w
    return dfs(nast[0], nast)


if __name__ == '__main__':
    print('generate test original sbt....')
    get_ast('../data/test/code', '../data/test/sbt')

    print('generate valid original sbt....')
    get_ast('../data/valid/code', '../data/valid/sbt')

    print('generate train original sbt....')
    get_ast('../data/train/code', '../data/train/sbt')
